...
<div class="col-lg-2">
    <div id="recetas" class="card-body collapse out" aria-expanded="true">
        <hr>
        <div class="row m-b-20 m-l-20">
            @foreach( $recetas as $receta )
                <div class="col-md-4">
                    <button type="button" class="btn btn-default waves-effect btn-panel" onclick="window.location.href='{{ $usuario->id }}/receta/{{ $receta->id }}'">
