...
$(document).ready(function(){
    (function(){
        $('body').on('click', '#menu-filtro', function(){
            if (!$(this).hasClass('checked')) {
                ...
                setTimeout(function(){
                    ...
                    $('#menu-filtro').removeClass('checked');
                    $('#content .card').attr('style', 'padding: 0px');
                }, 250);
            }
        });
    })();
...
$(document).ready(function(){
    ...
    (function(){
        ...
        $('body').on('click', '#menu-trigger, #chat-trigger', function(e){            
            ...
            if (x == '#filtro') {
                $elem = '#filtro';
                $elem2 = '#filtro-trigger';
                
                $('#menu-filtro').removeClass('open');
            ...
            if ($('#header').hasClass('filtro-toggled')) {
                $(document).on('click', function (e) {
                    if (($(e.target).closest($elem).length === 0) && ($(e.target).closest($elem2).length === 0)) {
                        setTimeout(function(){
                            $('body').removeClass('modal-open');
                            $($elem).removeClass('toggled');
                            $('#header').removeClass('filtro-toggled');
